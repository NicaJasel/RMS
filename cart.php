...
<div id="center">
 <h1>MY SHOPPING CART</h1>
    ...
    // Free the result sets for the queries
    mysqli_free_result($result1); // Free the result set for the first query
    mysqli_free_result($result2); // Free the result set for the second query
