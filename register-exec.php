...
function clean($str) {
    global $conn;
    $str = trim($str); // Just trim the input
    return mysqli_real_escape_string($conn, $str); // Escape the string for SQL
}
...
if (mysqli_num_rows($result_select) > 0) {
    ...
    // Create INSERT query
    $qry = "INSERT INTO members(firstname, lastname, login, passwd, question_id, answer) VALUES('$fname','$lname','$login','" . md5($password) . "','$question_id','" . md5($answer) . "')";
